...
import { TagModel } from './tag.model'; // Adjust path as needed
import { CategoryModel } from './communityCategory.model'; // Adjust path as needed
...
(async () => {
  try {
    ...
    const getCategoryId = (name: string): Types.ObjectId => {
