...
exports.assertValidChatMediaUrl = assertValidChatMediaUrl;
const MAX_URL_LENGTH = 2048;
/** Giphy CDN hosts used for downsized/full GIF URLs from the API. */
function isGiphyMediaHost(hostname) {
    const h = hostname.toLowerCase();
    if (h === "media.giphy.com" || h === "i.giphy.com")
        return true;
 ...
 */
function assertValidChatMediaUrl(raw, kind) {
